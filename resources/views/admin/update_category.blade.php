        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <div class="container-fluid p-0">
                    ...
                    <h1 style="float: left;" class="h3 mb-3 text-center"><strong>Update Category</strong></h1>

                    <div class="col-12 " style="clear:both;">

                        <form action="{{url('updateAllCategories', $data->id)}}" method="POST" enctype="multipart/form-data">
